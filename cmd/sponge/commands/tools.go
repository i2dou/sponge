...
var installToolCommands = map[string]string{
	...
	"protoc-gen-go-gin":      "github.com/i2dou/sponge/cmd/protoc-gen-go-gin@latest",
	"protoc-gen-go-rpc-tmpl": "github.com/i2dou/sponge/cmd/protoc-gen-go-rpc-tmpl@latest",
