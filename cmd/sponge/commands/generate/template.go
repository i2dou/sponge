...
if [ -f "${DOCKERFILE_PATH}/grpc_health_probe" ]; then
	...
	configFileCode = `// code generated by https://github.com/i2dou/sponge

package config

import (
	"github.com/i2dou/sponge/pkg/conf"
)
...
`
	...
	configFileCcCode = `// code generated by https://github.com/i2dou/sponge
