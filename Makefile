...
PROJECT_NAME := "github.com/i2dou/sponge"
PKG := "$(PROJECT_NAME)"
...
install:
	...
	go install github.com/i2dou/sponge/cmd/protoc-gen-go-rpc-tmpl@latest
...
graph:
	...
	go-callvis -skipbrowser -format=svg -nostd -file=serverNameExample_mixExample github.com/i2dou/sponge
